...
public class Evaluation {
    ...
    //cannot take advantage of lazy evaluation on logical operator since the parameters are already evaluated
    ...
    public static void main(final String[] args) {
        ...
        //due to eager evaluation the 2 operations have to be loaded first
        //4 seconds
        System.out.println("//" + "START:EAGER_OUTPUT");
        eagerEvaluator(evaluate(1), evaluate(2));
        System.out.println("//" + "END:EAGER_OUTPUT");

        //due to lazy loading the operations, only 1 gets evaluated. Hence faster
        //best is 2 seconds
